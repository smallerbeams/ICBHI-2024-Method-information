...
from model_factory import AE_CNN_246_shaopu_fristlayer_plus_Dense64_class,\
            AE_CNN_246_shaopu_seclayer_plus_Dense64_class,AE_CNN_246_shaopu_thirdlayer_plus_Dense64_class
...
def data_read2(csv_path):
    ...
    test_list = [x for x in test_list if x != "0"]
...
if __name__ == '__main__':
    ...
    csv_split = 'D:/ICBHI2024/Dataset/classsplit.csv'
    data_root = 'D:/ICBHI2024/Dataset/Train_Data_Mat/'
    pretrain_weight = 'D:/ICBHI2024/Code/weight/AE_CNN_246_shaopu/AE_CNN_246_shaopu_final_weight.h5'
    save_weight = 'D:/ICBHI2024/Code/weight/CNN_246_shaopu_thirdlayer_plus_Dense64_class'
    weight_name = 'CNN_246_shaopu_thirdlayer_plus_Dense64_class'

    x_train, x_val, x_test = data_read(csv_split)
    # x_train, x_val, x_test = data_read2(csv_split)
    ...
    # model = AE_CNN_246_shaopu_seclayer_plus_Dense64_class()
    model = AE_CNN_246_shaopu_thirdlayer_plus_Dense64_class()
