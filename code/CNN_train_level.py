...
from model_factory import AE_CNN_246_shaopu_seclayer_plus_Dense128_level,\
...
if __name__ == '__main__':
    ...
    csv_split = 'D:/ICBHI2024/Dataset/levelsplit.csv'
    data_root = 'D:/ICBHI2024/Dataset/Train_Data_Mat/'
    save_weight = 'D:/ICBHI2024/Code/weight/CNN_246_shaopu_thirdlayer_plus_Dense128_level'
    weight_name = 'CNN_246_shaopu_thirdlayer_plus_Dense128_level'
    ...
    epochs = 5000
    batch_size = 32
    train_data_gn = data_gen_fn(x_train, data_root, batch_size=batch_size,filter_df=need_fmri,aug=False)
    val_data_gn = data_gen_fn(x_val, data_root, batch_size=1,filter_df=need_fmri,aug=False)
    ...
    # model = AE_CNN_246_shaopu_seclayer_plus_Dense128_level()
