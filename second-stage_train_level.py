...
def create_model(base_model,n_class=9):
...
if __name__ == '__main__':
    ...
    csv_split = 'D:/ICBHI2024/Dataset/levelsplit.csv' ##dataset
    ...
    save_weight = 'D:/ICBHI2024/Code/weight/AE_CNN_246_shaopu_thirdlayer_plus_Dense128_level' ##save weight path
    weight_name = 'AE_CNN_246_shaopu_thirdlayer_plus_Dense128_level' ##save weight name
